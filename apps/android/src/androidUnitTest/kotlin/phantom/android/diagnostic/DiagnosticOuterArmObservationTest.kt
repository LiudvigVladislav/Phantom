 ...
 * provider with a closure over
 * `AppContainer.transportPreferences.privacyMode`; in these unit tests
 * we inject a synthetic lambda and assert the guard returns the
