      ...
      {[1, 2, 3, 4].map((level) => (
        <div
          ...
          style={{
            ...
            height: 4 + level * 3,
            borderRadius: 1,
            background: level <= strength ? "#6C5CE7" : "rgba(255,255,255,0.12)",
          }}
        />
      ))}
    </div>
    ...
    <PhoneFrame>
      ...
      <div className="flex-1 overflow-y-auto" style={{ background: "#0B0D12" }}>
        ...
        <div className="px-6 pt-8 pb-6 text-center">
          ...
          <p
            style={{ color: "#8A8FA3", fontSize: "14px", lineHeight: "1.6", maxWidth: 280, margin: "0 auto" }}
          >
          ...
          <div className="flex gap-2">
            {[
              ...
              >
                ...
                <span style={{ color: "#F4F7FB", fontSize: "12px", fontWeight: 500 }}>
                  {chip.label}
                </span>
                <span
            ...
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  width: 36,
                  height: 36,
                  background: broadcast ? "rgba(108,92,231,0.15)" : "rgba(255,255,255,0.04)",
                  border: `1px solid ${broadcast ? "rgba(108,92,231,0.3)" : "rgba(255,255,255,0.06)"}`,
                }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={broadcast ? "#6C5CE7" : "#8A8FA3"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div>
                <p className="font-medium" style={{ color: "#F4F7FB", fontSize: "14px" }}>
                  Broadcast presence
                </p>
                <p style={{ color: "#8A8FA3", fontSize: "11px" }}>
        ...
        <div className="px-4 pb-4">
          <div className="mb-3 flex items-center justify-between">
            ...
            <span style={{ color: "#8A8FA3", fontSize: "11px" }}>Scanning…</span>
          </div>
            ...
            {nearbyDevices.map((device, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-medium" style={{ color: "#F4F7FB", fontSize: "13px" }}>
                    {device.name}
                  </p>
                  <p
                    className="font-mono"
                    style={{ color: "#8A8FA3", fontSize: "11px" }}
                  >
                    {device.label}
                  </p>
                </div>
                ...
                {/* Lock icon */}
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8A8FA3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="px-6 pb-10">
          <p
            ...
            style={{ color: "#8A8FA3", fontSize: "11px", lineHeight: "1.7" }}
          >
