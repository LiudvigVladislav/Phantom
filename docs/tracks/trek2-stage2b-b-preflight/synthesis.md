...
The user reviews this synthesis and locks D1-D14 (or amends them) plus OQ-1-OQ-6. After the locks land, the scope-doc for Stage 2B-B drafts against this material. Implementation does not start until the scope-doc is reviewed and locked. WORKING_RULES rule 8 is binding: Stage 2B-B is not shippable without the Tele2 LTE smoke.
