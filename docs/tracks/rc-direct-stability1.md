...
**Memory pointer.** Vladislav-locked design + 5 hard gates + A/B/C/D refinements trail preserved in memory entry `project_next_session_arm_a2_outcome_plus_t2_plus_arm_g_2026_06_05.md`; superseded by this PR's §13 mini-lock landing on master.
