...
| Fonts (active) | `apps/android/src/androidMain/kotlin/phantom/android/ui/theme/PhantomTypography.kt` + `res/font/` | Geist / Inter / JetBrains Mono bundled as variable .ttf binaries. See `docs/font-setup/README.md` for details, source attributions, and the production-font swap path. |
