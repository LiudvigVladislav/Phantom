...
**Defense-in-depth:** before Beta, run this past an external legal-review channel (some FOSS funding programmes include free legal counsel for licence-compatibility questions). One paragraph email confirming this analysis = belt + suspenders.
...
4. **External legal review on MPL+Exhibit-B aggregation with AGPL.** Stated in §5.3; queue an email to a FOSS legal-counsel channel when timing allows. Pre-emptive evidence: v2rayNG (GPL) and Hiddify-app (GPL) already do this, no upstream complaint, no SFConservancy enforcement action.
