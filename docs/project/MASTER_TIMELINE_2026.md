...
**Last updated:** 2026-05-19 (tue, evening) — M2f trilogy closed: production voice chunk size locked to 3200 bytes after Test #69/#70/#70.1/#70.2/#71. Long-voice total delay on Tele2 LTE dropped from ~150 s (pre-M2) to ~50 s (-67 %). Per-chunk download RTT (~1.1 s) is the next bottleneck → PR-M2h pooled OkHttp download A/B  
