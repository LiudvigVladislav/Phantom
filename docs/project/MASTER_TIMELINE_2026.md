...
**Strategic posture (2026-05-14):** no fixed deadlines — quality over speed, honest over polished. Tags are not goals; functional quality is the goal. Phase 0 (repo hygiene, doc honesty, FCM removal, libsignal mention removal, internal-docs split, stale-branch prune) starts after this entry.
