...
- WS pong timeout cycle every 60–110 s on both devices remains as **PR-H1b/c** material (separate from H2 line). Auto-recovery works after H2a/H2a.2/H2b merged, so messages arrive but the UI shows momentary "lagging."
