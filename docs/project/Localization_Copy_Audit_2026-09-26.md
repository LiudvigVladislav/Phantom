...
Terms, migration, and channel work still need review. Published policy was not
...
1. Resolve the outstanding Terms, migration, and Create Channel findings with named approved wording or an explicit decision to keep a surface inaccessible. Pricing preview and Nearby unavailable copy are resolved for this stage, not certified as completed features. The Terms and migration decisions must honor their legal/ADR ownership.
