...
| 010 | [Transport Reconnect Deadlock](ADR-010-transport-reconnect-deadlock.md)                                              | The `forceShutdownActiveEngine` + `cancelAndJoin` discipline that lets `KtorRelayTransport` recover from middlebox-killed connections cleanly | Accepted |
...
| 013 | [Revised Transport Diagnosis 2026-05-02](ADR-013-revised-transport-diagnosis-2026-05-02.md)                          | Root-cause analysis for the MTS WiFi 50–120 s drop pattern that pushed the project toward the ADR-016 hybrid                                  | Accepted |
